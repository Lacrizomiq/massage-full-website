            ...
            <div className="flex flex-col flex-1 gap-4 pl-0 lg:pl-20">
              <div className="flex flex-col gap-2">
                ...
                <p className="max-w-xl text-lg leading-relaxed tracking-tight text-left lg:max-w-sm text-muted-foreground">
                  ...
                  inclinaison pour la spiritualité et le développement
                  personnel. Pratiquant de parkour passionné, il dirige
                  également une école de combat artistique de sabre laser.
                </p>
                <p className="max-w-xl text-lg leading-relaxed tracking-tight text-left lg:max-w-sm text-muted-foreground">
                  Enrichi par une expérience unique de trois mois avec des
                  moines bouddhistes en Chine, Corentin intègre des éléments de
                  méditation et de pleine conscience dans ses séances de
                  massage, de mobilité ainsi que de renforcement. Il guide ses
                  clients vers un équilibre harmonieux entre corps et esprit,
                  favorisant la relaxation, la flexibilité, et le bien-être
                  global.
                </p>
                <p className="max-w-xl text-lg leading-relaxed tracking-tight text-left lg:max-w-sm text-muted-foreground">
            ...
            <div className="flex flex-col flex-1 gap-4 pl-0 lg:pl-20">
              <div className="flex flex-col gap-2">
                ...
                <p className="max-w-xl text-lg leading-relaxed tracking-tight text-left lg:max-w-sm text-muted-foreground">
                  ...
                  bien-être mental crée un environnement équilibré et complet,
                  que ce soit pour un moment de relaxation ou pour améliorer tes
                  performances.
                </p>
                <p className="max-w-xl text-lg leading-relaxed tracking-tight text-left lg:max-w-sm text-muted-foreground">
