...
export default function MassageBienEtre() {
  return (
    <>
      <Link
        href="/"
            ...
            <div className="flex flex-col flex-1 gap-4 pl-0 lg:pl-20">
              <div className="flex flex-col gap-2">
                ...
                <p className="max-w-xl text-lg leading-relaxed tracking-tight text-left lg:max-w-sm text-muted-foreground">
                  ...
                  améliorer la santé générale et le bien-être psychologique
                  d'une personne à travers diverses techniques de massage.
                </p>
                <p className="max-w-xl text-lg leading-relaxed tracking-tight text-left lg:max-w-sm text-muted-foreground">
                  Contrairement au massage sportif, qui est orienté vers
                  l'amélioration des performances et la récupération physique
                  des sportifs, le massage bien-être se concentre sur la détente
                  globale, la réduction du stress et l'amélioration de la
                  qualité de vie.
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-col gap-10 lg:flex-row lg:items-center">
            <div className="flex flex-col flex-1 gap-4">
              <div className="flex flex-col gap-2">
                ...
                <p className="max-w-xl text-lg leading-relaxed tracking-tight text-left lg:max-w-sm text-muted-foreground">
                  Il s'adresse à toute personne cherchant à réduire son niveau
                  de stress, à améliorer son sommeil, ou simplement à se faire
        ...
        <div className="container mx-auto">
          <div className="flex flex-col-reverse gap-10 lg:flex-row lg:items-center">
            ...
            <div className="flex flex-col flex-1 gap-4 pl-0 lg:pl-20">
              <div className="flex flex-col gap-2">
                <h2 className="text-xl tracking-tighter text-left md:text-3xl lg:max-w-xl font-regular">
                  Envie de partager votre massage bien-être avec votre
                  partenaire ?
                </h2>
                <p className="max-w-xl text-lg leading-relaxed tracking-tight text-left lg:max-w-sm text-muted-foreground">
