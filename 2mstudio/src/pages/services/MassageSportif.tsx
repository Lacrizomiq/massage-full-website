            ...
            <div className="flex flex-col flex-1 gap-4 pl-0 lg:pl-20">
              <div className="flex flex-col gap-2">
                ...
                <p className="max-w-xl text-lg leading-relaxed tracking-tight text-left lg:max-w-sm text-muted-foreground">
                  ...
                  sollicités durant les exercices physiques, offrant une
                  approche personnalisée qui répond aux besoins spécifiques de
                  chaque sportif.
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-col gap-10 lg:flex-row lg:items-center">
            <div className="flex flex-col flex-1 gap-4">
              <div className="flex flex-col gap-2">
                ...
                <p className="max-w-xl text-lg leading-relaxed tracking-tight text-left lg:max-w-sm text-muted-foreground">
                  Nos massages sportifs sont conçus pour améliorer la
                  performance, la récupération, réduire la fatigue, prévenir les
                  blessures, soulager les douleurs musculaires et améliorer ta
                  concentration.
                </p>
                <p className="max-w-xl text-lg leading-relaxed tracking-tight text-left lg:max-w-sm text-muted-foreground">
